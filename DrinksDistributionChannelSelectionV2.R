# Group 3 Rama Subba Reddy, Kaushlendra Kumar Verma, Lovely Kumari & Yanyun Wu
...
# setwd("/Users/lovely/Documents/MIS 545 Data Mining/Group Presentation")
...
distribution <- read_csv(file = "DrinksDistributionDatasetMasterFile.csv",
                 col_types = "cnffnnif",
                 col_names = TRUE)
